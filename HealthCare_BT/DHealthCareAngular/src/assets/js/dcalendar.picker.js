	...
	DCalendar.prototype = {
		...
		create : function(){
			var that = this,
				...
				overlay = $('<div class=""></div>'),
				wrapper = $('<div class="booked-calendar-wrap "></div>'),
				...
				calhead = $('<section class="calendar-top-selector" style="background-color: #09161c;color: white;"><span class="calendar-prev">&lsaquo;</span><span class="calendar-curr-month"></span><span class="calendar-next">&rsaquo;</span></section>'),
